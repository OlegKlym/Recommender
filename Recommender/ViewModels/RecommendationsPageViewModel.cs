...
namespace Recommender.ViewModels
{
    ...
    public class RecommendationsViewModel : FreshBasePageModel
    {
        ...
        public RecommendationsViewModel(IServiceProvider serviceProvider)
        {
        ...
        private async Task LoadRecommendationsAsync()
        {
            ...
            {
                Console.WriteLine("APP_ERROR: Завантаження рекомендацій було скасовано.");
            }

            catch (TimeoutException)
            {
                Console.WriteLine("APP_ERROR: Завантаження рекомендацій зайняло забагато часу.");
            ...
            {
                Console.WriteLine($"APP_ERROR: Помилка завантаження рекомендацій: {ex.Message}");
